  ...
  <div class="bg-gray-100 p-8 ml-96 mr-96 rounded-2xl">
    ...
    >
      <div class="mb-4">
        ...
        <p>
          La formation CDA (Concepteur Développeur d'Applications) au centre de
          formation Expernet Campus est un titre de niveau 6 - RNCP 31174 sur 2
          ans, offrant des alternances avec des entreprises. Pour réussir cette
          formation il faut valider un examen final sous forme de présentation
          orale d'un projet conçu et dévloppé en application web & mobile.
        </p>
      </div>
