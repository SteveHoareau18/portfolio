...
let arrowSvg = '<svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10"> <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/></svg>';
export let cardsConfig = [
    ...
    },
    {
        ...
        description: "En cours d'acquisition. BAC+4 <span class='underline'>Concepteur Développeur d'Applications</span> au centre de formation Expernet. Découvrez ce que j'ai fait durant ces 2 années.",
        img: {
            href: "#",
            src: "https://expernet-campus.re/wp-content/uploads/2021/09/logo-expernet-e1645011344789.png"
        },
        readMore: {
            href: "",
            text: 'En savoir plus '+arrowSvg,
